...
MIXED Productividad BY Sujeto Tarea1  DevAppr1
  ...
  /FIXED=Tarea1  DevAppr1 | SSTYPE(3)
  /METHOD=REML
...
EXAMINE VARIABLES=Productividad RESID_1 BY Tarea1  DevAppr1
  /PLOT NPPLOT
  /COMPARE GROUPS
  /STATISTICS DESCRIPTIVES
  /CINTERVAL 95
...
EXAMINE VARIABLES=Productividad RESID_2 BY Tarea1  DevAppr1
  /PLOT NPPLOT
  /COMPARE GROUPS
  /STATISTICS DESCRIPTIVES
  /CINTERVAL 95
...
EXAMINE VARIABLES=Productividad RESID_3 BY Tarea1  DevAppr1
  /PLOT NPPLOT
  /COMPARE GROUPS
  /STATISTICS DESCRIPTIVES
  /CINTERVAL 95
...
EXAMINE VARIABLES=Productividad RESID_4 BY Tarea1  DevAppr1
  /PLOT NPPLOT
  /COMPARE GROUPS
  /STATISTICS DESCRIPTIVES
  /CINTERVAL 95
...
EXAMINE VARIABLES=Productividad RESID_5 BY Tarea1  DevAppr1
  /PLOT NPPLOT
  /COMPARE GROUPS
  /STATISTICS DESCRIPTIVES
  /CINTERVAL 95
...
EXAMINE VARIABLES=Productividad RESID_6 BY Tarea1  DevAppr1
  /PLOT NPPLOT
  /COMPARE GROUPS
  /STATISTICS DESCRIPTIVES
  /CINTERVAL 95
